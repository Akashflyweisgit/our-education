    ...
    <>
      <div className="Page_width content_padding">
        <div className="ml-3 mr-3">
          <div className="Content_topHeading">Manage Video</div>
          <hr />

          <div className="text-center sub_content mt-3 mb-2">Video List</div>

          <div className="text-right">
            <Button className="add_button">Add Video</Button>
          </div>
